"""fashionita_23771 URL Configuration
...
admin.site.site_header = "Fashionita"
admin.site.site_title = "Fashionita Admin Portal"
admin.site.index_title = "Fashionita Admin"

# swagger
api_info = openapi.Info(
    title="Fashionita API",
    default_version="v1",
    description="API documentation for Fashionita App",
)
